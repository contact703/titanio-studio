# BOOTSTRAP — Setup Completo para o OpenClaw do Tiago
...
Você é o agente do Tiago. Leia este arquivo e execute TODOS os passos abaixo.
...
- Telefone: (preencher)
- Projetos ativos: (preencher com Tiago)
...
```bash
openclaw node run --host 192.168.18.174 --port 18789 --display-name "Tiago Node"
```
