# Setup Completo — Helber
# Dashboard Titanio v2 + Sistema de Memória + LightRAG + Especialistas
# O OpenClaw do Helber deve ler este arquivo e executar tudo
...
JWT_SECRET="titanio-helber-2026"
...
<plist version="1.0"><dict>
  ...
  <key>ProgramArguments</key><array>
    ...
    <string>cd ~/titanio-dashboard/code/backend && node dist/index.js >> /tmp/backend-helber.log 2>&1</string>
  </array>
...
- Projetos: (preencher com os projetos do Helber)
EOF
```
...
echo -n "1. Dashboard Backend: "; curl -m 3 -s http://localhost:4445/ > /dev/null 2>&1 && echo "✅" || echo "❌"
echo -n "2. Dashboard Frontend: "; curl -m 3 -s http://localhost:3001 > /dev/null 2>&1 && echo "✅" || echo "❌"
...
Todos devem ser ✅. Acesse http://localhost:3001 para ver a Dashboard.
